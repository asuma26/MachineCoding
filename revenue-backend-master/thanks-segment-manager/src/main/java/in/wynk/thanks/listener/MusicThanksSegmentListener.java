...
@Profile("!local")
@Component
public class MusicThanksSegmentListener implements IKinesisRecordHandler {

    private static final Logger logger = LoggerFactory.getLogger(MusicThanksSegmentListener.class);

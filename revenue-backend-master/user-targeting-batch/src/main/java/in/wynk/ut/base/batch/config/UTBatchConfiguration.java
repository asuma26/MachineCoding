...
public class UTBatchConfiguration {
    ...
    @Bean
    public Job userTargetJob(@Qualifier("userTargetStep") Step userTargetStep) {
    ...
    @Bean
    public Step userTargetStep(@Qualifier("utBaseReader") ItemReader<UserTarget> utBaseReader) {

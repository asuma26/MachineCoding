...
import in.wynk.partner.security.filter.BasicPartnerAuthenticationFilter;
...
public class PartnerSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    private final AuthenticationProvider basicPartnerAuthenticationProvider;
    ...
    public PartnerSecurityConfig(SecurityProperties properties,
                                 AuthenticationProvider s2sAuthenticationProvider,
                                 AuthenticationProvider basicPartnerAuthenticationProvider,
        ...
        this.basicPartnerAuthenticationProvider = basicPartnerAuthenticationProvider;
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .addFilter(new BasicPartnerAuthenticationFilter(authenticationManagerBean()));
    }

    @Override
    protected void configure(AuthenticationManagerBuilder auth) {
        auth.authenticationProvider(s2sAuthenticationProvider);
        auth.authenticationProvider(basicPartnerAuthenticationProvider);
    }

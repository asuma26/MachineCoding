...
public class OrderFulfilmentSQSMessageExtractor extends AbstractSQSMessageExtractor {

    @Value("${order.pooling.queue.fulfilment.sqs.messages.extractor.batchSize}")
    private int batchSize;

    @Value("${order.pooling.queue.fulfilment.sqs.messages.extractor.waitTimeInSeconds}")
    private int waitTimeInSeconds;

    private final String queueName;

    public OrderFulfilmentSQSMessageExtractor(String queueName,

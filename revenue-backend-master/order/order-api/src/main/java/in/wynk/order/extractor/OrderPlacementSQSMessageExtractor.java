...
public class OrderPlacementSQSMessageExtractor extends AbstractSQSMessageExtractor {

    @Value("${order.pooling.queue.placement.sqs.messages.extractor.batchSize}")
    private int batchSize;

    @Value("${order.pooling.queue.placement.sqs.messages.extractor.waitTimeInSeconds}")
    private int waitTimeInSeconds;

    private final String queueName;

    public OrderPlacementSQSMessageExtractor(String queueName,
